...
@pytest.mark.parametrize("expected", [[0, 1, 2, 3, 4]])
...
@pytest.mark.parametrize(
    "ex1, ex2, ex3, ex4", [([0, 1, 2], [1, 0, 2], [1, 2, 0], [0, 2, 1])]
)
...
@pytest.mark.parametrize("n, i, j, truth", [(3, 1, 2, True), (3, 2, 1, False)])
...
@pytest.mark.parametrize(
    "n, i, j, change_rate, truth1, ex, truth2",
    [
